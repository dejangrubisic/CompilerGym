...
setup_kwargs = {
    ...
    "packages": [
        ...
        "compiler_gym.envs.loop_tool.datasets",
        "compiler_gym.envs.loop_tool.datasets.loop_tool_dataset",
        "compiler_gym.envs.loop_tool.service",
        "compiler_gym.envs.loop_tool.service.datasets",
        "compiler_gym.envs.loop_tool.service.env",
        "compiler_gym.envs.loop_tool.service.rewards",
        "compiler_gym.envs",
        "compiler_gym.envs",
        "compiler_gym.errors",
